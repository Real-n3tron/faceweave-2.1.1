...
from faceweave.face_analyser import get_face_analyser
...
def start(benchmark_runs : List[str], benchmark_cycles : int) -> Generator[List[Any], None, None]:
	faceweave.globals.source_paths = [ '.assets/examples/source.jpg' ]
...
def benchmark(target_path : str, benchmark_cycles : int) -> List[Any]:
	...
	for i in range(benchmark_cycles):
		...
		faceweave.globals.output_path = normalize_output_path(faceweave.globals.source_paths, faceweave.globals.target_path, tempfile.gettempdir())
